  ...
  return (
    <main className="flex-1 px-4 py-20">
      <div className="mx-auto max-w-md text-center">
        <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-soft">
        ...
        <h1 className="text-h1 text-heading mb-3">{t("communityTitle")}</h1>
        <p className="text-body text-sub mb-8">{t("communityDesc")}</p>
